...
class Log(object):
    ...
    def __init__(self,params):
        ...
        self._write()
        self._str = "Name;Frequency;Usage;Stats;Cache Items;Timeslot \n"
        self._write()
    ...
    def insert_log(self,file_obj,timeslot,stats,cache):
        self._str = str(file_obj.name)+';'+str(file_obj.frequency)+';'+str(file_obj.usage)+';'+stats+';'+cache+';'+str(timeslot)+"\n"
        self._write()    